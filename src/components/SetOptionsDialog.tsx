...
const SetOptionsDialog: React.FC<SetOptionsDialogProps> = ({
  isVisible,
  onClose,
  onSetTypeChange,
  onDelete,
  ...
  return (
    ...
    >
      <View style={styles.overlay}>
        <View className="bg-white dark:bg-gray-800 rounded-t-xl p-4 w-full" style={styles.container}>
...
export default SetOptionsDialog;
